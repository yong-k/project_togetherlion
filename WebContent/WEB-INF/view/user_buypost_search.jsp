...
<script type="text/javascript">
	...
	$(function()
	{
		...
		$('#category-select').on("change", function()
		{
			...
			if (url.indexOf('&maincate') != -1)
				url = url.substring(0, url.indexOf('&maincate'));
			
			url += "&maincate=" + $(this).val();
        ...
        <div class="row">
            <div class="col-lg-12 text-center">
                <div class="breadcrumb__text">
                    <h2 class="search-title">상품검색</h2>
                </div>
                <form action="">
                	<input type="text" class="buypost-search"/>
                	<button type="button" class="buypost-search-btn"><i class="bi bi-search buypost-search-icon"></i></button>
                	<hr class="buypost-search-bottom"/>
                </form>
            </div>
        </div>
    </div>	
		...
		<div class="container">
			<div class="row featured__filter">
				<div class="col-lg-12 col-md-12">
					<div class="filter__item buypost-search">
						<div class="row">
