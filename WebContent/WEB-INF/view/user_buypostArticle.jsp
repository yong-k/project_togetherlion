			...
			<div class="row">
					...
					<div class="product__details__pic">
						<div class="product__details__pic__item">
							<img class="product__details__pic__item--large"
								src="img/buypost/${buypost.goods_photo_name }">
				...
				<div class="col-lg-5 col-md-5 detail-container">
					<div class="product__category">
						<a href="<%=cp %>/buypostcategory.lion?main=${buypost.main_cate_code }" class="category">${buypost.main_cate_name }</a> 
						<i class="fa fa-angle-right" aria-hidden="true"></i> 
						<a href="<%=cp %>/buypostcategory.lion?main=${buypost.main_cate_code }&sub=${buypost.sub_cate_code }" class="category">${buypost.sub_cate_name }</a>
					</div>
					<div class="product__details__text">
						...
						<a href="#!">
							<div class="product__details__profile">
								<div class="buypost_profile_photo">
									...
									<img src="img/mannerLevel/${buypost.photo_name}" />
								</div>
								<div class="buypost_profile_nickname">${buypost.nickname }</div>
							</div>
						</a>
						<div class="product__details__box">
							<div class="product__details__label">1인 가격</div>
							<div class="product-price">\ ${buypost.price }</div>
						</div>
						<div class="product__details__box">
							<div class="product__details__label">유통기한</div>
							<c:choose>
								<c:when test="${buypost.expiration_datetime == null}">
									<div class="product__details__value">모름</div>
								</c:when>
								<c:otherwise>
						...
						<div class="product__details__box">
							<div class="product__details__label totalBuyNum_label">
								현재 구매한 상품 개수<span class="buyNum">${buypost.buy_number }/${buypost.goods_num }</span>
							</div>
							<div class="progress buypost-progress">
								<div class="progress-bar bg-warning" role="progressbar"
									style="width: ${buypost.buy_number / buypost.goods_num * 100}%" aria-valuenow="${buypost.buy_number / buypost.goods_num * 100}" aria-valuemin="0"
									aria-valuemax="100"></div>
							</div>
						</div>
						<div class="product__details__box">
							<div class="product__details__label">거래 위치</div>
							<div class="product__details__value" id="trade_location">서울 마포구 서교동 445-7</div>
						</div>
						<div class="product__details__box">
						...
						<div class="product__details__box">
							...
							<div class="product__details__value">
	                        	${buypost.left_day }일 
	                        	${buypost.left_hour }시간  
	                        	${buypost.left_minute }분                    
							</div>
						</div>
						...
						<div class="tab-content">
							<div class="tab-pane active" id="tabs-1" role="tabpanel">
								<div class="product__details__tab__desc buypost-location">
									...
									<input type="hidden" id="location_x" value="${buypost.location_x }" />
									<input type="hidden" id="location_y" value="${buypost.location_y }" />
								...
								<div class="col-lg-12">
									...
									<div class="buypost-detail-content">
										<c:if test="${buypost.content_photo_name != null }">
											<div id="content_img_box">
												<img id="content_img" src="img/buypost/content/${buypost.content_photo_name }">
											</div>
										</c:if>
										${buypost.content }
									</div>
							...
							<div class="tab-pane" id="tabs-2" role="tabpanel">
								<div class="product__details__tab__desc participate-profile-detail">
									<!-- 참여자목록 -->
									<c:forEach var="participant" items="${participant_info }">
										<a href="#!">
											<div class="product__details__profile participate-profile">
												<div class="buypost_profile_photo participate-profile-photo">
													<img src="img/mannerLevel/${participant.photo_name}" />
												</div>
												<div class="buypost_profile_nickname participate-profile-nickname">${participant.nickname }</div>
											</div>
										</a> 
									</c:forEach>
								</div>
