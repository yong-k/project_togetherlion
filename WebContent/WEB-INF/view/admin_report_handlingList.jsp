					...
					<div class="nav">
						...
						<div class="collapse show" id="report" aria-labelledby="headingFive"
							...
							<nav class="sb-sidenav-menu-nested nav">
								...
								<a class="nav-link current-menu" href="<%=cp %>/admin_reporthandlinglist.lion">처리내역</a> 
						...
						<div class="card-body">
							<table class="table table-bordered table-hover">
								...
								<tbody>
									<tr>
										<td>3</td>
										<td>akf39@daum.net</td>
										<td>공동구매</td>
										<td><a href="admin_report_handlingDetail.jsp">g7523</a></td>
										<td>gachi394@gmail.com</td>
										<td>판매금지품목</td>
										<td>2022-05-29</td>
										<td>ej456</td>
										<td>
											<span class="badge rounded-pill bg-danger report-handling-badge">승인</span>
										</td>
										<td>2022-05-31</td>
									</tr>
									<tr>
										...
										<td>afea@daum.net</td>
										<td>커뮤니티</td>
										<td><a href="admin_report_handlingDetail.jsp">c3834</a></td>
										<td>dfaf2@gmail.com</td>
										<td>친목</td>
										<td>2022-05-28</td>
										<td>sj293</td>
										<td>
											<span class="badge rounded-pill bg-secondary report-handling-badge">반려</span>
										</td>
										<td>2022-05-30</td>
									</tr>
									<tr>
										<td>1</td>
										<td>qosjfq@daum.net</td>
										<td>댓글</td>
										<td><a href="admin_report_handlingDetail.jsp">r9512</a></td>
										<td>dfad33@daum.net</td>
										<td>부적절한 내용</td>
										<td>2022-05-28</td>
										<td>sj293</td>
										<td>
