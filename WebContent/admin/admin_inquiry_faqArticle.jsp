					...
					<div class="card mb-4">
						...
						<div class="card-body">
							<div class="receptionDetail-container">
								<h2 class="head">FAQ 내용</h2>
								<div class="mb-3 row">
									<label for="title" class="col-sm-1 col-form-label">제목</label>
									<div class="col-sm-6">
										<input type="text" readonly class="form-control-plaintext faq-title-text"
											id="title" value="포인트 충전은 어디서 하나요?">
									</div>
								</div>
								<div class="mb-3 row">
									<span class="inquiryAnswer-label col-sm-2 col-form-label">내용</span>
									<div class="receptionDetail col-sm-6">
										마이페이지 > 포인트 에서 충전 가능합니다 *^^*
									</div>
								</div>
							</div>
							<div class="btn-container notice-btn">
								...
								<button type="button" class="adminBtn saveBtn answerInsertBtn"
									onclick="location.href='admin_inquiry_faqUpdateForm.jsp'">수정</button>
							</div>
							<div>
								<div class="reportDetail-helper"></div>
								<button type="button" class="adminBtn listBtn"
									onclick="location.href='admin_inquiry_faqList.jsp'">목록</button>
							</div>
